# Generated by Django 2.2 on 2020-01-29 10:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('SliderArticles', '0002_articlepost'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(null=True)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article_comments2', to='SliderArticles.Comment')),
